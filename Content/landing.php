    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#portfolio">Samples</a>
          </li>
          <li class="nav-item">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal1">
            ...
            <img class="img-fluid" src="http://fridge-o-matic.com/Images/teriyaki-salmon-fried-rice.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Teriyaki Salmon</h4>
            <p class="text-muted">Fried Rice</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal2">
            ...
            <img class="img-fluid" src="http://fridge-o-matic.com/Images/black-bean-quesadilla.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Black Bean</h4>
            <p class="text-muted">Quesadilla</p>
          </div>
        </div>
        <div class="col-md-4 col-sm-6 portfolio-item">
          <a class="portfolio-link" data-toggle="modal" href="#portfolioModal3">
            ...
            <img class="img-fluid" src="http://fridge-o-matic.com/Images/cajun-chicken-and-shrimp.jpg" alt="">
          </a>
          <div class="portfolio-caption">
            <h4>Cajun</h4>
            <p class="text-muted">Chicken & Shrimp</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <ul class="timeline">
            <li>
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="https://www.flaticon.com/premium-icon/icons/svg/1021/1021409.svg" alt="">
              </div>
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="https://image.flaticon.com/icons/svg/2546/2546359.svg" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>Inventory</h4>
            ...
            <li>
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="https://www.flaticon.com/premium-icon/icons/svg/2092/2092940.svg" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>Shopping List</h4>
            ...
            <li class="timeline-inverted">
              <div class="timeline-image">
                <img class="rounded-circle img-fluid" src="https://image.flaticon.com/icons/svg/1073/1073777.svg" alt="">
              </div>
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4>Get Started</h4>
                ...
                <div class="timeline-body">
                  <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#">Go!</a>
                </div>
              </div>
            </li>
            <li class="timeline-inverted">
          ...
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <div class="modal-body">
                ...
                <p class="item-intro text-muted">Lorem ipsum dolor sit amet consectetur.</p>
                <img class="img-fluid d-block mx-auto" src="http://fridge-o-matic.com/Images/black-bean-quesadilla.jpgg" alt="">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est blanditiis dolorem culpa incidunt minus dignissimos deserunt repellat aperiam quasi sunt officia expedita beatae cupiditate, maiores repudiandae, nostrum, reiciendis facere nemo!</p>
                <ul class="list-inline">
                  <li>Black Beans</li>
                  <li>Cheese</li>
